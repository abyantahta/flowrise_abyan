  ...
  return (
    ...
    >
      ...
      <path
        stroke="#0891B2"
        strokeWidth="4.991"
        d="M50 73.333V16.667c0-4.714 0-7.071-1.465-8.536C47.072 6.667 44.715 6.667 40 6.667s-7.071 0-8.535 1.464C30 9.596 30 11.953 30 16.667v56.666"
      ></path>
      <path
        stroke="#0891B2"
        strokeOpacity="0.5"
  ...
  return(
    ...
    >
      <path
        stroke="#0891B2"
        strokeWidth="4.991"
        d="M49.859 30.237L40 40l-9.859-9.763c-9.742-9.647-14.612-14.47-13.249-18.632.117-.358.263-.706.436-1.04C19.335 6.666 26.223 6.666 40 6.666c13.777 0 20.665 0 22.672 3.897.173.335.319.683.436 1.04 1.363 4.163-3.507 8.986-13.249 18.633z"
      ></path>
      <path
        stroke="#0891B2"
        strokeOpacity="0.5"
